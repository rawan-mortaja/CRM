                        ...
                        <form class="form-inline">
                            <div class="input-group input-group-sm">
                                <form action="{{ URL::current() }}" method="get"
                                    class="row row-cols align-items-center">
                        ...
                        <div class="col-12 col-sm-6 col-md-6">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">{{ Auth::user()->contact->count() }}</span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <span class="badge badge-danger">{{ Auth::user()->contact->count() }}
                                                    New Members</span>
                                        ...
                                        <div class="card-body p-0">
                                            <ul class="users-list clearfix">
                                                @foreach (Auth::user()->contact as $contacts)
                                                    <li>
                                                        <img src="dist/img/user1-128x128.jpg" alt="User Image">
                                                        <a class="users-list-name"
                                                            href="{{ route('contacts.show', $contacts->id) }}">{{ $contacts->firstName }}
                                                            {{ $contacts->lastName }}</a>
                                        ...
                                        <div class="card-footer text-center">
                                            <a href="{{ route('contacts.index') }}">View All Customers</a>
                                        </div>
                                        <!-- /.card-footer -->
                                    </div>
                                    <!--/.card -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer clearfix">
                                    <a href="{{ route('contacts.create') }}"
                                        class="btn btn-sm btn-info float-left">Add New
                                        Customer</a>
